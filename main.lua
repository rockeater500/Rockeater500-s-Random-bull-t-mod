...
SMODS.ObjectType({
    key = "rockeater500_rockeater500_jokers",
    cards = {
        ["j_rockeater500_addition"] = true,
        ["j_rockeater500_division"] = true,
        ["j_rockeater500_multiplication"] = true,
        ["j_rockeater500_subtraction"] = true
    },
})
